...
class BrokersControllerTest < ActionController::TestCase
  ...
  test "should create broker" do
    assert_difference('Broker.count') do
      post :create, broker: { DemoAccount: @broker.DemoAccount, Expirations: @broker.Expirations, Image: @broker.Image, MaximunAmountTrade: @broker.MaximunAmountTrade, MinimumAmountTrade: @broker.MinimumAmountTrade, MinimumDeposit: @broker.MinimumDeposit, Name: @broker.Name, Regulated: @broker.Regulated, USAFriendly: @broker.USAFriendly, Url: @broker.Url }
    end
  ...
  test "should update broker" do
    patch :update, id: @broker, broker: { DemoAccount: @broker.DemoAccount, Expirations: @broker.Expirations, Image: @broker.Image, MaximunAmountTrade: @broker.MaximunAmountTrade, MinimumAmountTrade: @broker.MinimumAmountTrade, MinimumDeposit: @broker.MinimumDeposit, Name: @broker.Name, Regulated: @broker.Regulated, USAFriendly: @broker.USAFriendly, Url: @broker.Url }
    assert_redirected_to broker_path(assigns(:broker))
  end
